 ...
 *
 */
public class RoundRobinByWeightLoadBalanceStrategy implements LoadBalanceStrategy{

    //约定的invoker和权重的键值对
    final private List<Node> nodes;

    public RoundRobinByWeightLoadBalanceStrategy(Map<Invoker, Integer> invokersWeight){
    ...
    public void printCurrenctWeightBeforeSelect(){
        if (checkNodes()) {
            ...
            nodes.forEach(node->out.append(node.invoker.id())
                    .append("  currentWeight=").append(node.currentWeight)
                    .append("  effectiveWeight=").append(node.effectiveWeight)
                    .append(" plus = ")
...
//            @Override
//            public Endpoint id() {
//                return new Endpoint("192.168.0.1",80);
//            }
//
//
//        }, aWeight);
...
//            @Override
//            public Endpoint id() {
//                return new Endpoint("192.168.0.2",80);
//            }
//
//        }, bWeight);
//
...
//            @Override
//            public Endpoint id() {
//                return new Endpoint("192.168.0.3",80);
//            }
//
//        }, cWeight);
//
//        Integer times = 7;
//        RoundRobinByWeightLoadBalanceStrategy roundRobin = new RoundRobinByWeightLoadBalanceStrategy(invokersWeight);
